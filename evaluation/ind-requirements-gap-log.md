...
## File: `ind-requirements-gap-log.csv`

```csv
gap_id,source,source_reference,requirement_id,observed_gap,gap_type,rgds_impact,linked_backlog_item,evidence_reference,notes
